---
title: "Site de co-voiturage"
context: "Semestre 1 - SAE - Trinôme"
tags: ["HTML/CSS"]
screenCaps: 
  - "/miniature/covoiturage.png"
...
Ce projet avait pour objectif la création d’un site Web (statique) au nom d’une grande entreprise de l’informatique et qui doit représenter une hypothétique plateforme d’éco-mobilité. Nous avons choisi de prendre Microsoft, et avons donc du respecter sa charte graphique.

Ce projet faisait partie d'un plus grand projet commun à plusieurs matières, mais je ne présenterai que la partie informatique.
...
J'ai passé énormément de temps en plus à travailler sur ce projet les midi afin de m'améliorer en HTML et en CSS et fournir un travail de qualité.

## Résultats 

J'ai été très satisfait du rendu final de nos pages. Bien que le site était statique, l'ajout d'animations et de fausses pages de validations donnaient une bonne impression de fonctionnalité. La charte graphique, bien que sobre, était très proche de mon objectif, et j'ai pu expérimenter avec de nombreux outils de Web design.

<u>Note finale</u> : **16.00/20** (parmi les meilleurs notes)

## Compétences 

### Compétences techniques 

* **Structuration HTML** : Les différentes pages devaient être correctement constituées afin d'avoir un CSS lisible et ordonné.
* **Style CSS** : Le style CSS était la part majeur du travail, avec beaucoup de temps passé à essayer les différents outils de positionnement (flex, flexbox, grid...)
* **Considérations ergonomiques** : Une des notions évaluées était la logique de l'acheminement des pages et les retour utilisateur. Il a donc fallu travailler l'ergonomie du site et sa responsivité, afin que l'utilisateur comprenne ce qu'il a à faire, dans quel ordre et qu'il ait un retour sur ses actions, le gardant concentré. 
...
Ce projet, bien que de faible envergure, m'a initialement poussé dans mes retranchements, puisqu'il s'appuyait sur une matière dans laquelle j'étais en difficulté. Cependant, avec de la volonté et des efforts, j'ai su outrepasser mes appréhensions pour combler mes faiblesses. J'en suis ressorti renforcé, pas uniquement d'un point de vue technique, mais aussi de façon plus générale sur mon approche au travail. Confronté à la difficulté, je sais qu'avec de l'implication et de l'application, je peux passer outre et réussir mes objectifs.
...
[SAE Web](https://github.com/LouisHUARD/SAE-Site-WEB)